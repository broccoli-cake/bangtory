...
interface LaundryReservationScreenProps {
  onBack: () => void;
}
...
const reservations = [
  { day: 1, time: 2, name: '최현경' },
  { day: 2, time: 5, name: '김민영' },
  { day: 6, time: 7, name: '홍수한' },
];

export default function LaundryReservationScreen({ onBack }: LaundryReservationScreenProps) {
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-[#F9FAFB] font-toss">
      <div className="max-w-[390px] min-h-[844px] h-[844px] w-full bg-white shadow-2xl rounded-[24px] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 pt-6 pb-2 bg-white z-10">
          ...
          <div className="flex-1 text-center text-lg font-bold text-[#191F28]">세탁기 예약</div>
          <div className="w-8" />
        </div>
        {/* 예약표 + 폼 스크롤 */}
